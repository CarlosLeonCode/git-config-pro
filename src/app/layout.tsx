...
export const metadata: Metadata = {
  ...
  description:
    "Generate .gitignore, .gitattributes, .editorconfig, and .dockerignore files instantly. Smart detection, 20+ technologies, and best practices for modern developers.",
  keywords: [
    "git",
    "gitignore",
    "gitattributes",
  ...
  authors: [
    { name: "CarlosLeonCode", url: "https://github.com/carlosleoncode/" },
  ],
  ...
  metadataBase: new URL("https://git-config-pro.carlosleoncode.dev"),
  openGraph: {
    title: "GitConfig Pro - Ultimate Git Config Generator",
    description:
      "The smartest way to generate Git configuration files. Support for Node.js, Python, Ruby, Go, and more.",
    url: "https://git-config-pro.carlosleoncode.dev",
    siteName: "GitConfig Pro",
    images: [
      {
        url: "https://git-config-pro.carlosleoncode.dev/og-image.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "GitConfig Pro",
    description:
      "Generate battle-tested boilerplate configurations for your next project.",
    site: "@gitconfigpro",
    creator: "@carlosleoncode",
