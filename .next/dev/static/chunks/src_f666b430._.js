...
const ClickSpark = ({ sparkColor = '#fff', sparkSize = 10, sparkRadius = 15, sparkCount = 8, duration = 400, easing = 'ease-out', extraScale = 1.0, children })=>{
    ...
    const handleClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ClickSpark.useCallback[handleClick]": (e)=>{
            const canvas = canvasRef.current;
            if (!canvas) return;
            ...
            const newSparks = Array.from({
                ...
                "ClickSpark.useCallback[handleClick].newSparks": (_, i)=>({
                        x,
                        y,
                        angle: 2 * Math.PI * i / sparkCount,
                        startTime: now
                    })
            }["ClickSpark.useCallback[handleClick].newSparks"]);
            sparksRef.current.push(...newSparks);
        }
    }["ClickSpark.useCallback[handleClick]"], [
        sparkCount
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClickSpark.useEffect": ()=>{
            ...
            return ({
                "ClickSpark.useEffect": ()=>window.removeEventListener('click', handleClick, true)
            })["ClickSpark.useEffect"];
        }
    }["ClickSpark.useEffect"], [
        handleClick
...
_s(ClickSpark, "EJT+FgGgBJgWjRLIBIVYnuAeX0s=");
_c = ClickSpark;
...
//# sourceMappingURL=src_f666b430._.js.map